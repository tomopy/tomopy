...
configure-out()
{
    echo "${TOMOPY_DEVICE}-${DATA_TYPE}-${TOMOPY_NUM_GPU}-${TOMOPY_INTER}-${TOMOPY_BLOCK_SIZE}-${TOMOPY_GRID_SIZE}-${TOMOPY_PYTHON_THREADS}-${TOMOPY_NUM_THREADS}-${TOMOPY_USE_C_ALGORITHMS}"
}

...
class Gridrec():
    ...
    def run(self, TomoObj, slice_no=None):
        """ 
        ...
        TomoObj = np.array(TomoObj.data[:, slice_no, :], dtype='float32')
        self.data = np.empty((num_slices,
        ...
        while True:
            recon_complete, slices_remaining = Gridrec.poll()

...
def pml(data, theta, center, num_grid, iters, beta, init_matrix):
    """
    ...
    librecon.pml.restype = ctypes.POINTER(ctypes.c_void_p)
    librecon.pml(data.ctypes.data_as(c_float_p),

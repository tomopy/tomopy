...
void sirt(float* data, float* theta, float center, 
    ...
    for (t = 0; t < iters; t++) {
        ...
        update = (float *)calloc((num_slices*num_grid*num_grid), sizeof(float));
        norays = (float *)calloc((num_slices*num_grid*num_grid), sizeof(float));

...
#mydata.read_tiff(filename, projections_start, projections_end, slices_start = 800, slices_end = 1001, white_start = white_start, white_end = white_end, dark_start= dark_start, dark_end = dark_end)
